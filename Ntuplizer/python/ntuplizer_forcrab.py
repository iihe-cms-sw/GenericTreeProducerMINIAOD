...
skims = ['', 'MCJECs', 'ZJetsResiduals', 'MCJECs', 'HFJet', 'L1Unprefirable', 'L1Study', 'L1Study_ZToMuMu', 'L1Study_ZToEE', 'L1Study_SingleMuforJME', 'L1Studies_EphemeralHLTPhysics,', 'L1Studies_EphemeralZeroBias', 'L1Study_SinglePhotonforJME']
...
process.jmeanalyzer = cms.EDAnalyzer('JMEAnalyer',
